...
[BASE] = LAYOUT_exr(
   ...
   [NAVR] = LAYOUT_exr(
    ...
    KC_NA,   KC_ALGR, KC_NA,   KC_NA,   KC_NA,   KC_NU,   KC_HOME, KC_INS,  KC_END,  KC_NU,
  ...
  [MOUR] = LAYOUT_exr(
    ...
    KC_NA,   KC_ALGR, KC_NA,   KC_NA,   KC_NA,   KC_NU,   KC_WH_L, KC_BTN3, KC_WH_R, KC_NU,
    KC_NP,   KC_NP,   KC_NA,   KC_NA,   KC_NA,   KC_BTN1, KC_BTN2, KC_NA, 	KC_NP,   KC_NP
  ),
  [MEDR] = LAYOUT_exr(
    ...
    KC_NA,   KC_ALGR, KC_NA,   KC_NA,   KC_NA,   KC_NU,   KC_NU,   KC_MUTE, KC_NU,   KC_NU,
    KC_NP,   KC_NP,   KC_NA,   KC_NA,   KC_NA,   KC_MSTP, KC_MPLY, KC_NA, 	KC_NP,   KC_NP
  ),
  [FUNL] = LAYOUT_exr(
    ...
    KC_F10,  KC_F1,   KC_F2,   KC_F3,   KC_PAUS, TG(GAME),KC_NA,   KC_NA,   KC_ALGR, KC_NA,
  ...
  [GAME] = LAYOUT_exr(
    ...
    KC_LCTL, KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    KC_N,    KC_COMM, KC_DOT,	 KC_SLSH,
