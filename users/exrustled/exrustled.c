...
[BASE] = LAYOUT_exr(
  ...
  [MOUR] = LAYOUT_exr(
    ...
    KC_NA,   KC_NA,   KC_NA,   KC_NA,   KC_NA,   KC_NU,   KC_WH_L, KC_BTN3, KC_WH_R, KC_NU,
  ...
  [MEDR] = LAYOUT_exr(
    ...
    KC_NA,   KC_NA,   KC_NA,   KC_NA,   KC_NA,   KC_NU,   KC_NU,   KC_MUTE, KC_NU,   KC_NU,
  ...
  [GAME] = LAYOUT_exr(
    ...
    KC_NP,   KC_NP,   KC_LALT, KC_SPC,  KC_TAB,  LT(NSSL, KC_ENT),  LT(FUNL, KC_DEL), KC_DEL,  KC_NP,   KC_NP
  )
};
