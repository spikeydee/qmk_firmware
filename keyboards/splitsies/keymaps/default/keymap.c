/* Copyright 2025 spikeydee <@spikeydee>
 *
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [3] = LAYOUT(
    ...
    QK_BOOT,  KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS,        KC_F14,  KC_F15,  KC_VOLD, KC_VOLU,  KC_TRNS,
                              KC_TRNS, KC_SLEP,         KC_TRNS,  KC_TRNS
  ),

  [4] = LAYOUT(
    KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS,        MS_BTN1, MS_BTN2, KC_TRNS, KC_TRNS, KC_TRNS,
    KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS,        MS_LEFT, MS_DOWN, MS_UP, MS_RGHT, KC_TRNS,
    C_LEFT,  C_DOWN,  C_UP,    C_RIGHT, KC_TRNS,        MS_WHLU, MS_WHLD, KC_TRNS, KC_TRNS, KC_TRNS,
                               KC_TRNS, KC_TRNS,        KC_TRNS, KC_TRNS
  )
};
